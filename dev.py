...
if __name__ == "__main__":
    ...
    print_row_mean("Fläche öffenbare Fenster (betrachteter Raum) [m²]:".ljust(75), result["inputs"]["window_area_room"])
    ...
    if "ResH2O" in result:
        ...
        print_row_mean("Fläche öffenbare Fenster (gesamte Wohneinheit) [m²]:".ljust(75), result["inputs"]["window_area_unit"])
