...
location2Terr = {
    "Wien": [1, 1, 2.5, 5.5],
    "St. Pölten": [1, 1, 2.5, 4.5],
    "Eisenstadt": [1, 1, 2.5, 4.5],
    "Graz": [1, 1, 2.5, 4.5],
    "Klagenfurt": [1, 1, 2.5, 4.5],
    "Linz": [1, 1, 2.5, 4.5],
    "Salzburg": [1, 1, 2.5, 4.5],
    "Innsbruck": [1, 1, 2.5, 4.5],
    "Bregenz": [1, 1, 2.5, 4.5],
    "St. Anton": [1, 1, 1.5, 3.5],
    "Lienz": [1, 1, 1.5, 3.5],
    "Zell am See": [1, 1, 1.5, 3.5],
    "Schladming": [1, 1, 1.5, 3.5],
    "Leoben": [1, 1, 1.5, 3.5],
    "Gmünd": [1, 1, 1.5, 3.5],
}
location2Shield = {
    "Wien": [1, 1, 2.5, 5.5],
    "St. Pölten": [1, 1, 1.5, 4.5],
    "Eisenstadt": [1, 1, 1.5, 4.5],
    "Graz": [1, 1, 1.5, 4.5],
    "Klagenfurt": [1, 1, 1.5, 4.5],
    "Linz": [1, 1, 1.5, 4.5],
    "Salzburg": [1, 1, 1.5, 4.5],
    "Innsbruck": [1, 1, 1.5, 4.5],
    "Bregenz": [1, 1, 1.5, 4.5],
    "St. Anton": [1, 1, 1.5, 4.5],
    "Lienz": [1, 1, 1.5, 4.5],
    "Zell am See": [1, 1, 1.5, 3.5],
    "Schladming": [1, 1, 1.5, 3.5],
    "Leoben": [1, 1, 1.5, 3.5],
